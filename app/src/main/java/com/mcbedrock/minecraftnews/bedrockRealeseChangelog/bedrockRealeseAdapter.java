        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (view_changelog_info_type == 1) {
                    ...
                    intent.putExtra("img_link", model.img_link);
                    intent.putExtra("name_title", model.name_title);
                    intent.putExtra("version", model.version);
                    intent.putExtra("description", model.description);
                    intent.putExtra("changelog_link", model.changelog_link);
