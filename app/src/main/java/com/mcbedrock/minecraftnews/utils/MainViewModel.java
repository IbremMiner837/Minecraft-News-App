...
public class MainViewModel extends ViewModel {
    ...
    private final String CHANNEL_ID = "UC1sELGmy5jp5fQUugmuYlXQ";
    private static String KEY = "AIzaSyC0-QuSGQA31mwQAlNwyLghxdMaNIaYjdc";
    ...
    public void fetchStatistics(String videoId) {
        ...
        String requestUrl = videoStats.generateStatsRequest(videoId, KEY);
