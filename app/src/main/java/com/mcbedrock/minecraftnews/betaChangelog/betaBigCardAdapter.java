...
public class betaBigCardAdapter extends FirebaseRecyclerAdapter<BetaChangelogModel, betaBigCardAdapter.myviewholder> {
    ...
    public betaBigCardAdapter(@NonNull FirebaseRecyclerOptions<BetaChangelogModel> options) {
        super(options);
    }
