...
public class javaBigCardAdapter extends FirebaseRecyclerAdapter<javaChangelogModel, javaBigCardAdapter.myviewholder> {
    ...
    public javaBigCardAdapter(@NonNull FirebaseRecyclerOptions<javaChangelogModel> options) {
        super(options);
    }
